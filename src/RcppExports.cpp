...
// meshed_casc
Rcpp::List meshed_casc(const arma::mat& y, const arma::uvec& family, const int k, const arma::mat& X, const arma::mat& coords, const arma::field<arma::uvec>& parents, const arma::field<arma::uvec>& children, const arma::vec& layer_names, const arma::vec& layer_gibbs_group, const arma::field<arma::uvec>& indexing, const arma::field<arma::uvec>& indexing_obs, const arma::mat& beta_Vi, const arma::mat& start_w, const arma::ivec& matern_twonu, const arma::cube& lambda_values, const arma::cube& theta_values, const arma::mat& beta, int maxit, int num_threads, bool adapting, bool use_cache, bool forced_grid, bool verbose, bool debug, int print_every, bool casc_beta, bool casc_w);
RcppExport SEXP _meshed_meshed_casc(SEXP ySEXP, SEXP familySEXP, SEXP kSEXP, SEXP XSEXP, SEXP coordsSEXP, SEXP parentsSEXP, SEXP childrenSEXP, SEXP layer_namesSEXP, SEXP layer_gibbs_groupSEXP, SEXP indexingSEXP, SEXP indexing_obsSEXP, SEXP beta_ViSEXP, SEXP start_wSEXP, SEXP matern_twonuSEXP, SEXP lambda_valuesSEXP, SEXP theta_valuesSEXP, SEXP betaSEXP, SEXP maxitSEXP, SEXP num_threadsSEXP, SEXP adaptingSEXP, SEXP use_cacheSEXP, SEXP forced_gridSEXP, SEXP verboseSEXP, SEXP debugSEXP, SEXP print_everySEXP, SEXP casc_betaSEXP, SEXP casc_wSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< const arma::ivec& >::type matern_twonu(matern_twonuSEXP);
    Rcpp::traits::input_parameter< const arma::cube& >::type lambda_values(lambda_valuesSEXP);
    Rcpp::traits::input_parameter< const arma::cube& >::type theta_values(theta_valuesSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(meshed_casc(y, family, k, X, coords, parents, children, layer_names, layer_gibbs_group, indexing, indexing_obs, beta_Vi, start_w, matern_twonu, lambda_values, theta_values, beta, maxit, num_threads, adapting, use_cache, forced_grid, verbose, debug, print_every, casc_beta, casc_w));
    return rcpp_result_gen;
END_RCPP
}
// meshed_mcmc
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_meshed_meshed_casc", (DL_FUNC) &_meshed_meshed_casc, 27},
